...
app.login().then(user => {
	...
	item.usr_image_id = { name: `${login}.png`, content: img1 };
	...
	item.usr_image_id = { name: `${login}.jpg`, content: img2 };
